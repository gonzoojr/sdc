<html>
	...
	<body>
		...
		<table class="borda-arr bodyPrint">
			<tr class="meia">
				<th>
					Proposta Comercial: 
		...
		<table id="listaItens" class="borda-arr bodyPrint">
			<tr class="print">
				<th width="40px">Item </th><th>Descrição</th><th>NCM</th><th width="90px">Valor Unit</th><th width="80px">ICMS</th><th width="80px">IPI</th><th width="80px">ISS</th><th width="120px">Subst. Trib.</th><th>Qtd</th><th width="120px">&nbsp;</th>
			</tr>
		...
		if(isset($_GET['id'])){
			...
			$linha = '<tr class="comum print" id="linha_'.$posicao_item.'">'
					.'<td align="center">'.$posicao_item.'
					...
					.'<td class="descricao">'.nl2br($descricaoAD).'</td>'
					.'<td>'.$Ncm_item.'</td>'
			...
			echo '<tr class="total" id="total">'
					...
					.'<td style="border: 1px solid #dadada;background:#c9e3f6;vertical-align:text-top;text-align: center;"><b>R$ '.$total_proposta.'</b></td>'
				.'</tr>';
		}
		?>
		...
		<table class="borda-arr">
			<tr class="comum">
				<td style="text-align: center;"><b>INFORMAÇÕES COMERCIAIS</b></td>
			</tr >
		</table>
		<br>
		<table class="borda-arr bodyPrint">
			<tr class="comum">
				<th>Prazo de Pagamento:</th> <td id="prazoPgto">- à vista;</td>
			</tr >
			<tr class="comum">
