...
//			mssql_set_charset('iso-8859-1');
			...
			if(isset($_POST['queryString']))
			{
					...
					if(strlen($queryString) >0) {
						...
						$query = mssql_query("SELECT prd_cod,prd_desc,preco_Usuario,preco_Integrador,categ_prod,prd_cor,prd_tamanho,oo_moeda_de_preco FROM produto WHERE prd_desc like '%" . $queryString . "%';");
						echo "<ul>";
